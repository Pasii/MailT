...
public class SendEmail {
	...
	//	attachments.add("C:\\Users\\tgherath\\Desktop\\hello gihan.txt");
		...
		setupEmail.sendEmail(emailBody, subject, recipients, from,attachments,username,password,URI);
