...
public class CopyOfSendEmail {
	...
	//	attachments.add("C:\\Users\\tgherath\\Desktop\\hello gihan.txt");
		...
		setupEmail.sendEmail(emailBody, subject, recipients, from, attachments,username,password,URI,footer,header);

	}

	public void sendEmail(String body, String subject, String recipients,
			String from, String attachments,String username,String password,String URI,String footerImage,String headerImage)
	...
	public static void setRecipientsArray(String[] recipientsArray) {
		CopyOfSendEmail.recipientsArray = recipientsArray;
	}
	...
	public static void setAttchementssArray(String[] attchementssArray) {
		CopyOfSendEmail.attachmentsArray = attchementssArray;
	}
